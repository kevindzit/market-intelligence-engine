...
PROVIDER_MODELS = {
    ...
    'chatgpt': {
        'name': 'ChatGPT',
        'models': {
            '1': {'name': 'GPT-4', 'desc': 'Most capable model', 'selector': 'gpt-4'},
            '2': {'name': 'GPT-3.5', 'desc': 'Faster, good for simple tasks', 'selector': 'gpt-3.5'},
        },
        'features': {
            'thinking_mode': False,
...
def main():
    ...
    try:
        ...
        # For Claude, try to select the specific model
        if provider == 'claude' and model_selector != 'Sonnet 4.5':
