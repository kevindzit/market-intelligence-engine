...
class TwitterDefi:
    def __init__(self):
        ...
        self.health = HealthMonitor('twitter_defi', alert_threshold=5)  # 5 empty cycles before alert (adjusted for MIN_FOLLOWERS filter)
    ...
    async def run(self):
        ...
        print("\n" + "="*60)
        print("Twitter DeFi Scraper")
        print("Tracking: UNI, AAVE, LDO, MKR, CRV, GMX, SNX")
        print("="*60)
