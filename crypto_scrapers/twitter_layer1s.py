...
class TwitterLayer1s:
    def __init__(self):
        ...
        self.health = HealthMonitor('twitter_layer1s', alert_threshold=5)  # 5 empty cycles before alert (adjusted for MIN_FOLLOWERS filter)
            ...
            for tweet in tweets:
                ...
                try:
                    ...
                    """, (
                        ...
                        'layer1s',  # Source identifier for Layer 1 blockchain searches
    ...
    async def run(self):
        ...
        print("\n" + "="*60)
        print("Twitter Layer 1 Scraper")
        print("Tracking: AVAX, DOT, NEAR, ATOM, ICP, ALGO, FTM")
        print("="*60)
