...
class TwitterAI:
    def __init__(self):
        ...
        self.health = HealthMonitor('twitter_ai', alert_threshold=5)  # 5 empty cycles before alert (adjusted for MIN_FOLLOWERS filter)
            ...
            for tweet in tweets:
                ...
                try:
                    ...
                    """, (
                        ...
                        'ai',  # Source identifier for AI/ML token searches
    ...
    async def run_cycle(self):
        ...
        # Collect AI/ML tweets - retry once with fresh cookies if auth fails
    ...
    async def run(self):
        ...
        print("\n" + "="*60)
        print("Twitter AI/ML Scraper")
        print("Tracking: RENDER, FET, GRT, OCEAN, AGIX, TAO, RNDR")
        print("="*60)
